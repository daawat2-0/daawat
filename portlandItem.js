const portLandMenu = [
    ...
    {itemName : "Mix Vegetable Pakora", price : 7.99,Ingredients : "Mixed vegetables coated in a chickpea batter and fried", type: "portlandVegAppetizers", imageLink : "./Menu/mix veg pakoda.JPG"},
    ...
    {itemName : "Onion Bhaaji", price : 7.99,Ingredients : "Onion Fritters coated in chickpea batter and fried, served chutney", type: "portlandVegAppetizers", imageLink : "./Menu/onion bhaji.JPG"},
    ...
    {itemName : "Lamb Seekh Kabab", price : 14.99,Ingredients : "Marinated Lamb in yogurt and spices threaded onto skewers, cooked in clay oven",type: "portlandNonVegAppetizers", imageLink : "./Menu/Lamb Seekh Kabab.png"},
    ...
    //Vegetarian Mains
    {itemName : "Channa Masala", price : 17.99, Ingredients : "Garbanzo beans made in Indian spices, onions, ginger, garlic & tomatoes.",type:"portlandVegetarianMains", imageLink : "./Menu/Chana masala.JPG"},
    ...
    {itemName : "Dal Makhani", price : 17.99, Ingredients : "Black lentils with subtle smoky flavors and rich creaminess",type:"portlandVegetarianMains", imageLink : "./Menu/Dal makhani.JPG"},
    ...
    {itemName : "Shahi Paneer", price : 18.99, Ingredients : "Paneer chunks simmered slowly in our special inhouse curry",type:"portlandVegetarianMains", imageLink : "./Menu/Shahi paneer.JPG"},
    {itemName : "Kadhai Paneer", price : 18.99, Ingredients : "Cheese cubes cooked in a gravy with onions, tomatoes, and bell peppers",type:"portlandVegetarianMains", imageLink : "./Menu/kadhai paneer.JPG"},
    ...
    {itemName : "Bhindi Masala", price : 17.99, Ingredients : "Semi dry, Okra curry, sautéed with spices, herbs, onions, and tomato's",type:"portlandVegetarianMains", imageLink : "./Menu/bhindi.JPG"},
    ...
    {itemName : "Methi Matar Mushroom", price : 17.99, Ingredients : "Mushroom and peas cooked in a buttery creamy white sauce",type:"portlandVegetarianMains", imageLink : "./Menu/methi matar mushroom.JPG"},
    ...
    {itemName : "Chicken Handi (Boneless)", price : 18.99, Ingredients : "Boneless chicken cooked in a whipped, aromatic, yogurt-tomato sauce and spices",type:"portlandNonVegetariansMains", imageLink : "./Menu/Chicken Handi (Boneless).png"},
    ...
    {itemName : "Kadhai Gosht", price : 20.99, Ingredients : "Juicy pieces of goat tossed in herbs and spices",type:"portlandNonVegetariansMains", imageLink : "./Menu/kadhai gosht.png"},
    {itemName : "Saag Gosht", price : 20.99, Ingredients : "Pieces of goat cooked in a creamy spinach gravy",type:"portlandNonVegetariansMains", imageLink : "./Menu/saag gosht.png"},
    ...
    // Rice Option
    {itemName : "Veg Biryani", price : 16.99, Ingredients : "Authentic Indian rice cooked with a special blend of veggies and spices.",type:"portlandRiceOption", imageLink : "./Menu/veg biryani.png"},
    {itemName : "Non-Veg Biryani", price : "17.99/18.99", Ingredients : "Authentic Indian rice cooked with a special blend of veggies, spices and your choice of meat. (Lamb, Goat, Chicken, Shrimp)",type:"portlandRiceOption", imageLink : "./Menu/non-veg biryani.png"},
    ...
    {itemName : "Garlic Naan", price : 3.99, Ingredients : "Naan bread laced with garlic & cilantro with butter",type:"portlandFreshlyBakedBread", imageLink : "./Menu/garlic naan.png"},
    ...
    {itemName : "Choley Bhature", price : 15.99, Ingredients : "Fried flatbread served with chickpea curry",type:"portlandIndianStreetFood", imageLink : "./Menu/Choley Bhature.png"},
    ...
    {itemName : "Mango Lassi", price : 5.99, Ingredients : "Made from yogurt, milk, and mango pulp",type:"portlandDrinksandDessertsCorner", imageLink : "./Menu/mango lassi.JPG"},
    {itemName : "Sweet Lassi", price : 5.99, Ingredients : "Made from yogurt and sugar",type:"portlandDrinksandDessertsCorner", imageLink : "./Menu/sweet lassi.JPG"},
    ...
    {itemName : "Masala Soda", price : 4.99, Ingredients : "Sparkling water with spices",type:"portlandDrinksandDessertsCorner", imageLink : "./Menu/masala soda.JPG"},
    {itemName : "Masala Chai", price : 5.99, Ingredients : "Indian Tea",type:"portlandDrinksandDessertsCorner", imageLink : "./Menu/masala chai.png"},
    {itemName : "Rose Milk", price : 5.99, Ingredients : "Milk with rose syrup",type:"portlandDrinksandDessertsCorner", imageLink : "./Menu/rose milk.JPG"},
    {itemName : "Salty Lassi", price : 5.99, Ingredients : "Made from yogurt and salt",type:"portlandDrinksandDessertsCorner", imageLink : "./Menu/Salty Lassi.png"},
    ...
    {itemName : "Kheer", price : 5.99, Ingredients : "Rice Pudding",type:"portlandDrinksandDessertsCorner", imageLink : "./Menu/kheer.png"},
